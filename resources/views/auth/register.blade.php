...
<head>
    ...
    <title>Register | Pustaka Utama</title>
    ...
    <div class="w-full max-w-[960px] h-[520px] bg-white rounded-[32px] shadow-2xl flex flex-row overflow-hidden border border-white/40">
        ...
        <div class="w-[42%] bg-[#D7CBE7] p-8 flex flex-col justify-between relative overflow-hidden">
            ...
            <div class="bg-white/80 rounded-2xl p-4 border border-white/60 z-10 shadow-sm">
                <h2 class="font-extrabold text-sm text-[#2F1D4A] leading-tight">Mulai Petualangan Membaca</h2>
                <p class="mt-1 text-[#593E7D] text-[11px] leading-relaxed font-medium">
                    Daftarkan akun Anda untuk menjelajahi ribuan koleksi buku digital dan literatur terbaik kami.
                </p>
            </div>
        </div>
        ...
        <div class="w-[58%] bg-white flex flex-col justify-center px-14 lg:px-18 relative">
            ...
            <div class="mb-5 mt-4">
                <h1 class="text-3xl font-black text-gray-800 tracking-tight">Buat Akun Baru</h1>
                <p class="text-gray-400 mt-1 text-xs">Silakan lengkapi data diri Anda di bawah ini.</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-3.5">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="text-[10px] font-black text-gray-400 uppercase tracking-wider">Kata Sandi</label>
                    ...
                    <div>
                        <label class="text-[10px] font-black text-gray-400 uppercase tracking-wider">Konfirmasi Sandi</label>
